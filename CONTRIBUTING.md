...
Thank you for contributing to the Antigravity transactional orchestration harness (`@illejivin/agy-mcp-server` and agent delegation skills). We welcome contributions that maintain rigor, deterministic execution, and process safety across multi-agent workflows.
