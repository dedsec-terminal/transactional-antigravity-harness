...
* **Sparse Checkout Status**: Opt-in sparse checkout remains an experimental proposal pending verification. While full checkouts avoid broken cross-module imports, there is no guarantee that all source is required for all checks.
