...
* **Adaptive Admission**: The runner reserves a slot before spawning AGY, using CPU and available memory with a hard maximum of eight workers. It can admit zero new workers under pressure. This behavior is implemented in this branch; no speedup has been measured.
